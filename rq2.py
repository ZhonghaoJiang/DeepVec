...
if __name__ == '__main__':
    ...
    for pre in range(1, 41):
        ...
        # state_w_in.append(state_w_P)
        # ran_in.append(random_P)
        # RNNTestcov_in.append(cov_P)
        # Stellarbscov_in.append(bscov_P)
        # Stellarbtcov_in.append(btcov_P)
        # sc_ctm_in.append(sc_ctm_P)
        # sc_cam_in.append(sc_cam_P)
        # nc_ctm_in.append(nc_ctm_P)
        # nc_cam_in.append(nc_cam_P)
        # my_in.append(my_cam_P)
        # deepgini_in.append(gini_P)
        # kmedoids_in.append(kmedoids_P)
        # mmdcritic_in.append(mmdcritic_P)
        # maxp_in.append(maxp_P)
