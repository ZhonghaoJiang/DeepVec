...
if __name__ == '__main__':
    ...
    weight_state, unique_index_arr_id, stellar_bscov, stellar_btcov, \
        rnntest_sc, nc_cov, nc_cam, rnntest_sc_cam, mymethod, trend_set, right = get_selection_information(
        to_select_path, model, lstm_classifier, dense_model, wrapper_path, w2v_path, time_steps)

    select_method = ['mymethod_selected', 'state_w_selected', 'random_selected', 'cov_selected', 'bscov_selected',
                     'btcov_selected',
