...
if __name__ == '__main__':
    ...
    aug_data = pd.DataFrame(columns=('news', 'label'))
    idx = 0
    ...
    for i in range(len(selected_data)):
        ori_text = selected_data.news[i]
        ori_intent = selected_data.label[i]
    ...
    aug_data.to_csv("./dau/agnews_harder/agnews_toselect.csv")
