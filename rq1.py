...
if __name__ == '__main__':
    ...
    deepgini_bdr,kmedoids_bdr,mmdcritic_bdr,maxp_bdr, ats_bdr = {}, {}, {},{},{}
    pre_li = [10, 20]
    # pre_li = [100]
    for i in pre_li:
        state_w_bdr[i] = []
    ...
    for file in files:
        ...
        for pre in pre_li:
            ...
            gini_bdr[pre].append(my_cam_P)
            deepgini_bdr[pre].append(gini_P)
            kmedoids_bdr[pre].append(kmedoids_P)
            mmdcritic_bdr[pre].append(mmdcritic_P)
            maxp_bdr[pre].append(maxp_P)
            ats_bdr[pre].append(ats_P)

        # print(gini_bdr,state_w_bdr, ran_bdr, RNNTestcov_bdr, Stellarbscov_bdr, Stellarbtcov_bdr, sc_ctm_bdr)

    # result_dict = {'dis_w10':gini_bdr[10],'dis_w20':gini_bdr[20],'dis_w50':gini_bdr[50],
    #                 'state_w10': state_w_bdr[10], 'state_w20': state_w_bdr[20], 'state_w50': state_w_bdr[50],
    ...
    result_dict = {'random10': ran_bdr[10], 'random20': ran_bdr[20],
                   'RNNTestcov10': RNNTestcov_bdr[10], 'RNNTestcov20': RNNTestcov_bdr[20],
                   'Stellarbscov10': Stellarbscov_bdr[10], 'Stellarbscov20': Stellarbscov_bdr[20],
                   'Stellarbtcov10': Stellarbtcov_bdr[10], 'Stellarbtcov20': Stellarbtcov_bdr[20],
                   'testRNNsc10': sc_ctm_bdr[10], 'testRNNsc20': sc_ctm_bdr[20],
                   'testRNNsc_cam10': sc_cam_bdr[10], 'testRNNsc_cam20': sc_cam_bdr[20],
                   'nc_ctm10': nc_ctm_bdr[10], 'nc_ctm20': nc_ctm_bdr[20],
                   'nc_cam10': nc_cam_bdr[10], 'nc_cam20': nc_cam_bdr[20],
                    'deepgini_10':deepgini_bdr[10],'deepgini_20':deepgini_bdr[20],
                   'kmedoids_10': kmedoids_bdr[10], 'kmedoids_20': kmedoids_bdr[20],
                   'mmdcritic_10': mmdcritic_bdr[10], 'mmdcritic_20': mmdcritic_bdr[20],
                   'maxp_10': maxp_bdr[10], 'maxp_20': maxp_bdr[20],
                   'state_w10': state_w_bdr[10], 'state_w20': state_w_bdr[20],
                   'ats_10': ats_bdr[10], 'ats_20': ats_bdr[20],
                   'Vec_w10':gini_bdr[10],'Vec_w20':gini_bdr[20]}
