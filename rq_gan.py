...
import pandas as pd
import os
from selection_tools import get_selected_data, get_val_data, gan_selection, get_gan_rank
import sys
...
if __name__ == '__main__':
    ...
    rank = get_gan_rank(to_select_path)

    select_method = ['gan_selected']
    ...
    for pre in pre_li:
        ...
        # selection
        ats_selected = gan_selection(rank, total_num, select_num)
        ...
        for method_item in select_method:
            ...
            if not os.path.isfile(retrained_model_path):  # Has not been saved, needs to be trained
                ...
                lstm_classifier.dau_retrain(args.dl_model, X_selected_array, Y_selected_array, x_aug_val, y_aug_val,
    ...
    output_dir = './exp_results/rq4-gan/'
    os.makedirs(output_dir, exist_ok=True)
    df.to_csv("./exp_results/rq-gan/rq-gan_{}_{}.csv".format(args.dataset, args.model_type))

    print(
        "Finished! The results are saved in: [./exp_results/rq-gan/rq-gan_{}_{}.csv]".format(args.dataset, args.model_type))